    ...
    <div className="">
      <div className="bg-[#212529] h-16 flex flex-row xs:flex-row items-center justify-between px-5 lg:px-20 xl:px-30 2xl:px-[15vw] sticky top-0 z-50 w-screen">
                ...
                <SheetDescription className="flex flex-col items-end gap-2 text-white">
                  ...
                  <SignedOut>
                    <SheetClose asChild>
                      <Link
                        href="/sign-up"
                        className="flex gap-2 text-lg hover:text-primary"
                      >
                        <UserPen size={24} />
                        <SignUpButton />
                      </Link>
                    ...
                    <SheetClose asChild>
                      <Button
                        className="w-24 bg-primary text-primary-foreground text-lg hover:bg-white hover:text-primary"
                        asChild
                      >
                        <div className="">
                          <SignInButton />
        ...
        <div className="items-center gap-4 hidden md:flex h-full">
          ...
          <SignedIn>
            <div className="px-4 hover:bg-primary h-full rounded-none flex items-center justify-center">
              <UserButton />
            </div>
          </SignedIn>
        </div>
